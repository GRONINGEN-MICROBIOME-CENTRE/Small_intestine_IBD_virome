...
#SBATCH --output=./out/10.vin/PD_no_neg_index.out
#SBATCH --mem=32gb
...
mkdir -p ../VIR_DB/mapping/VLP_at_MQ_der_all_db_95/alignment_log
mkdir -p ../VIR_DB/mapping/VLP_at_MQ_der_all_db_95/coverage
