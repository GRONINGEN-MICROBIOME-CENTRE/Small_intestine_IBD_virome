...
#SBATCH --output=./out/08.pru/VD_SI_%A_%a.out
#SBATCH --mem=32gb
...
module load R
Rscript New_contigs_ID_and_metadata.R /scratch/p282752/ANALYSIS_SI/SAMPLES/${SAMPLE_ID}/virome_discovery/tidy/ ${SAMPLE_ID}
