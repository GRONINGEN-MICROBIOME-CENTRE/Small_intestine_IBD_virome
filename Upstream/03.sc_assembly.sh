...
if [ -f ../SAMPLES/${SAMPLE_ID}/01_sc_assembly/${SAMPLE_ID}_contigs.fasta ]; then
	...
	echo "> Cleaning quast output"
        rm ../SAMPLES/${SAMPLE_ID}/01_sc_assembly/quast/*.txt
        rm ../SAMPLES/${SAMPLE_ID}/01_sc_assembly/quast/*.html
        rm ../SAMPLES/${SAMPLE_ID}/01_sc_assembly/quast/*.tex
        rm ../SAMPLES/${SAMPLE_ID}/01_sc_assembly/quast/*.pdf
        rm -r ../SAMPLES/${SAMPLE_ID}/01_sc_assembly/quast/basic_stats
        rm -r ../SAMPLES/${SAMPLE_ID}/01_sc_assembly/quast/icarus_viewers
fi
